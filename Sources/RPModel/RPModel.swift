...
open class RPModel: ObservableObject, DatabaseFetcher, Identifiable {
  ...
  fileprivate static var instances: [String: NSMapTable<NSNumber, RPModel>] = [
    String: NSMapTable<NSNumber, RPModel>
  ]()

  public static var createTableStatement: String {
    let model = Self()
    var creationStringComponents = [
      "CREATE TABLE",
      Self.tableName,
      "(",
...
extension RPModel {
  public static func inTransaction(
