...
fileprivate func decode<T: ReplicatingModel>(instance: T, container: KeyedDecodingContainer<TableNameCodingKey>) throws -> [T] {
  return try container.decode([T].self, forKey: .init(stringValue: instance.tableName))
}
