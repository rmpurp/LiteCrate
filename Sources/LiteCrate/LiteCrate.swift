...
public final class LiteCrate {
  ...
  private final class TransactionDatabaseProxy: DatabaseProxy {
    ...
    func executeUpdate(_ sql: String, values: [Any]?) throws {
      guard isEnabled else { fatalError("Do not use this proxy outside of the transaction closure") }
  ...
  public init(url: URL?, updateQueue: DispatchQueue = DispatchQueue.main, migration: (DatabaseProxy, inout Int64) throws -> Void) rethrows {
